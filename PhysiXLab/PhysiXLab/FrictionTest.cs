...
namespace Test
{
    ...
    public class FrictionTest : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            crate = new Crate(new Vector3(0.3f, 0.4f, 0.5f));
            ...
            camera = new Camera(this, new Vector3(0, 0, 0.1f),
                Vector3.Zero, Vector3.Up);
            Components.Add(camera);
            g = new Gravity(new Vector3(0f, -30f, 0f));
        ...
        protected override void Update(GameTime gameTime)
        {
            float duration = gameTime.ElapsedGameTime.Milliseconds / 5000f;
            if (Keyboard.GetState().IsKeyDown(Keys.Space))
                spaceClicked = true;
            if (Keyboard.GetState().IsKeyUp(Keys.Space) && spaceClicked)
            {
            ...
            if (Keyboard.GetState().GetPressedKeys().Contains(Keys.K))
                crate.Rotation = new Vector3(2, 0, 0);
